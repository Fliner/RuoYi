...
function selectUser(taskId) {
  var url = ctx + 'process/menu/user/authUser/selectUser?taskId=' + taskId;
...
function cancelApply(instanceId, createBy) {
  ...
  $.modal.confirm("确认要撤销申请吗?", function() {
    var url = ctx + "process/business/general/cancelApply";
...
function suspendOrActiveApply(instanceId, createBy, suspendState) {
  ...
  $.modal.confirm("确认要" + suspendOrActive + "申请吗?", function() {
    var url = ctx + "process/business/general/suspendOrActiveApply";
