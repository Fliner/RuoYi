...
public class ModelEditorJsonRestResource extends BaseController implements ModelDataJsonConstants {
  ...
  private static final String PREFIX = "/menu/modeler";
...
//    }
    ...
    @RequestMapping("/process/menu/modeler/modelList")
    public String modelList(HttpServletRequest request) {
        return "process" + PREFIX + "/modelList";
    }

    @PostMapping("/process/menu/modeler/list")
    @ResponseBody
...
//    }
    ...
    @GetMapping("/process/menu/modeler/addModal")
     ...
     * 创建模型
     */
    @RequestMapping(value = "/process/menu/modeler/create")
    @ResponseBody
     ...
     * 根据Model部署流程
     */
    @RequestMapping(value = "/process/menu/modeler/deploy/{modelId}")
    @ResponseBody
     ...
     * 导出model的xml文件
     */
    @RequestMapping(value = "/process/menu/modeler/export/{modelId}")
    public void export(@PathVariable("modelId") String modelId, HttpServletResponse response) {
        try {
            ...
            if (!CollectionUtils.isEmpty(bpmnModel.getProcesses())) {
                ...
                try {
                    response.sendRedirect("/process/menu/modeler/modelList");
    ...
    @PostMapping("/process/menu/modeler/remove")
    @ResponseBody
